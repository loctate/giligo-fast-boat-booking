/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c320b15226011695aa47b3e4f584d5e0)
...
interface __BaseEnv_Env {
	...
	APPWRITE_BOOKINGS_TABLE_ID: string;
	ADMIN_EMAIL: string;
	ADMIN_SESSION_COOKIE: string;
	APPWRITE_OPERATORS_TABLE_ID: string;
	APPWRITE_VESSELS_TABLE_ID: string;
	APPWRITE_ROUTES_TABLE_ID: string;
	APPWRITE_TRIP_SCHEDULES_TABLE_ID: string;
	APPWRITE_TRIP_INVENTORY_TABLE_ID: string;
	...
	CRON_SECRET: string;
	NUSAGILIBOAT_PUBLIC_BASE_URL: string;
	IPAYMU_BRIDGE_URL: string;
	IPAYMU_BRIDGE_INTERNAL_TOKEN: string;
	PAYMENT_VERIFICATION_MODE: string;
	PAYMENT_VERIFICATION_CODE_HASH: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPWRITE_ENDPOINT" | "APPWRITE_PROJECT_ID" | "APPWRITE_API_KEY" | "APPWRITE_DATABASE_ID" | "APPWRITE_BOOKINGS_TABLE_ID" | "ADMIN_EMAIL" | "ADMIN_SESSION_COOKIE" | "APPWRITE_OPERATORS_TABLE_ID" | "APPWRITE_VESSELS_TABLE_ID" | "APPWRITE_ROUTES_TABLE_ID" | "APPWRITE_TRIP_SCHEDULES_TABLE_ID" | "APPWRITE_TRIP_INVENTORY_TABLE_ID" | "MIDTRANS_IS_PRODUCTION" | "MIDTRANS_MERCHANT_ID" | "NEXT_PUBLIC_MIDTRANS_CLIENT_KEY" | "MIDTRANS_SERVER_KEY" | "NEXT_PUBLIC_SUPPORT_WHATSAPP" | "CRON_SECRET" | "NUSAGILIBOAT_PUBLIC_BASE_URL" | "IPAYMU_BRIDGE_URL" | "IPAYMU_BRIDGE_INTERNAL_TOKEN" | "PAYMENT_VERIFICATION_MODE" | "PAYMENT_VERIFICATION_CODE_HASH">> {}
}
