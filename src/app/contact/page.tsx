...
export const metadata: Metadata = {
  title:
    "Hubungi Kami | Nusa Gili Boat",
  description:
    "Hubungi tim Nusa Gili Boat untuk bantuan booking tiket fast boat, informasi jadwal, perubahan perjalanan, pembayaran, pembatalan, refund, dan e-ticket.",
}
    ...
    >
      ...
      <aside className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
        <h2 className="font-semibold text-amber-950">
          Informasi alamat sedang dilengkapi
        </h2>

        <p className="mt-2 leading-7 text-amber-900">
          Alamat operasional dan identitas resmi
          pemilik usaha akan ditambahkan setelah
          seluruh informasi administratif selesai
          dikonfirmasi.
        </p>
      </aside>
    </PublicInfoPage>
