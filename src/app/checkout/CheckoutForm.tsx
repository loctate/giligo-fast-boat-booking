...
return ( <form
 ...
 > <div className="space-y-7"> <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"> <div className="mb-6"> <p className="text-sm font-bold uppercase tracking-[0.16em] text-cyan-700">
Contact details </p>
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          The booking confirmation will be issued using
          these details.
        </p>
      </div>
    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          Enter each passenger&apos;s name as shown on
