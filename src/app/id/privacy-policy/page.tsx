...
export const metadata: Metadata = createPublicPageMetadata({
  locale: "id",
  path: "/privacy-policy",
  title: "Kebijakan Privasi | Nusa Gili Boat",
  description: "Kebijakan Privasi Nusa Gili Boat menjelaskan pengumpulan, penggunaan, penyimpanan, pembagian, dan perlindungan data pribadi pelanggan serta penumpang.",
})
