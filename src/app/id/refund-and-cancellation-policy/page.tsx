...
export const metadata: Metadata = createPublicPageMetadata({
  ...
  title: "Kebijakan Refund dan Pembatalan | Nusa Gili Boat",
  description: "Kebijakan pembatalan, perubahan booking, no-show, pembatalan operator, dan pengembalian dana untuk tiket fast boat yang dipesan melalui Nusa Gili Boat.",
})
