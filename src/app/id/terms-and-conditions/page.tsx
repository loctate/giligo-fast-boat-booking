...
export const metadata: Metadata = createPublicPageMetadata({
  ...
  title: "Syarat dan Ketentuan | Nusa Gili Boat",
  description: "Syarat dan ketentuan penggunaan situs, pencarian perjalanan, pemesanan, pembayaran, perubahan, pembatalan, dan layanan fast boat melalui Nusa Gili Boat.",
})
