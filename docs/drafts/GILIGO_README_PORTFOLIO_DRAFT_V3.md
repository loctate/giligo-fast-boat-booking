...
Add this section after the final screenshots have been captured and reviewed.

Recommended files:
docs/screenshots/01-public-search.png
docs/screenshots/02-trip-results.png
docs/screenshots/03-checkout.png
docs/screenshots/04-booking-confirmation.png
docs/screenshots/05-admin-dashboard.png
docs/screenshots/06-trip-inventory.png
docs/screenshots/07-booking-operations.png
docs/screenshots/08-departures.png
docs/screenshots/09-paid-manifest.png
docs/screenshots/10-manifest-print.png
